...
Dependencies:
- rawtextcheck.default_parameters.JSON_FILE_PATH: path to the JSON configuration file
- rawtextcheck.logger.get_logger: logging utility
- rawtextcheck.newtype.Item: type definition for project items
"""
...
from rawtextcheck.default_parameters import CONFIG_FOLDER, JSON_PROJECT_PATH
